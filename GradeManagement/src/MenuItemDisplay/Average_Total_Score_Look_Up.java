...
public class Average_Total_Score_Look_Up extends JFrame {
	...
	private JTextField average_total_scoreTextField; // 전체 총점 평균
	...
	public Average_Total_Score_Look_Up() {
		super("평균 총점 및 전체 성적 조회");
		...
		average_total_scoreTextField = new JTextField(10);
		...
		displayPanel.setLayout(new GridLayout(17, 2, 4, 4));
		...
		displayPanel.add(new JLabel("전체 총점 평균:"));
		average_total_scoreTextField.setEnabled(false);
		displayPanel.add(average_total_scoreTextField);
	...
	private void indexTextFieldActionPerformed(ActionEvent evt) {
		...
		average_look_up = studentsQueries.getAverageTotalScore();
		...
		if(numberOfEntries != 0 && currentEntryIndex < numberOfEntries) {
			...
			average_total_scoreTextField.setText(String.valueOf(average_look_up));
